...
public class TableAuthIdentityManager<T extends AuthIdentity> implements AuthIdentityManager<T> {
    ...
    public void createIdentity(String authenticationId, T identity) throws IdentityExistsException {
        ...
        // Check whether either ID conflicts with an existing identity.  Note that we can't protect from a race
        ...
        if (getIdentity(internalId) != null) {
        ...
        // Ignore whatever masked ID was passed in; mask it now
