...
public class CachingTest {
    ...
    protected ResourceTestRule setupResourceTestRule()  {
        ...
        authIdentityDAO.createIdentity("id0", "testkey", new ApiKeyModification().addRoles("testrole"));
        authIdentityDAO.createIdentity("id1", "othertestkey", new ApiKeyModification().addRoles("testrole"));
