...
public interface EventReaderDAO {
     ...
     * if it has cached these events as read then it can clear that cache.  The are no guarantees whether this will have
     * any effect on the reader, and calling this method on an event has been deleted via
