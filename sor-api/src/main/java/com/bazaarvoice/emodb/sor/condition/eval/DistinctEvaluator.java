 ...
 * input values at most one of the conditions returns true.
 *
 ...
 * stated this is only a partial implementation and does not return correct values if either the left or right input
