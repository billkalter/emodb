 ...
 * {@link #setUnassignRemainingRoles(boolean)} to true; the default is false.
 */
...
public class UpdateEmoApiKeyRequest extends UserAccessControlRequest {
    ...
    public UpdateEmoApiKeyRequest unassignRoles(Set<EmoRoleKey> removedRoles) {
    ...
    public UpdateEmoApiKeyRequest setUnassignRemainingRoles(boolean unassignRemainingRoles) {
