...
public class RoleAdminTaskTest {
    ...
    public void setUp() {
        ...
        _roleManager.createRole(adminId, new RoleModification()
                .setPermissionUpdate(new PermissionUpdateRequest().permit(ImmutableSet.of(Permissions.unlimitedRole()))));
    ...
    public void testViewRole()
        ...
        _roleManager.createRole(new RoleIdentifier(null, "view-role"), new RoleModification()
                .setPermissionUpdate(new PermissionUpdateRequest().permit(
