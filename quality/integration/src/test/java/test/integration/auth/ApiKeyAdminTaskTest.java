...
public class ApiKeyAdminTaskTest {
    ...
    private void createApiKeyWithPermissions(String key, String... permissions) {
        ...
        _authIdentityManager.createIdentity(internalId, key, new ApiKeyModification().addRoles(role));
    }
    ...
    public void testUpdateApiKey() throws Exception {
        ...
        String id = "id_update";
        _authIdentityManager.createIdentity(id, key, new ApiKeyModification().addRoles("role1", "role2", "role3"));
    ...
    public void testMigrateApiKey() throws Exception {
        ...
        _authIdentityManager.createIdentity(id, key, new ApiKeyModification().addRoles("role1", "role2"));
