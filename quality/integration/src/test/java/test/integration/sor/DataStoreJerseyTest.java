...
public class DataStoreJerseyTest extends ResourceTest {
    ...
    private ResourceTestRule setupDataStoreResourceTestRule() {
        ...
        authIdentityManager.createIdentity("id0", APIKEY_TABLE, new ApiKeyModification().addRoles("table-role"));
        authIdentityManager.createIdentity("id1", APIKEY_READ_TABLES_A, new ApiKeyModification().addRoles("tables-a-role"));
        authIdentityManager.createIdentity("id2", APIKEY_READ_TABLES_B, new ApiKeyModification().addRoles("tables-b-role"));
        authIdentityManager.createIdentity("id3", APIKEY_FACADE, new ApiKeyModification().addRoles("facade-role"));
        authIdentityManager.createIdentity("id4", APIKEY_REVIEWS_ONLY, new ApiKeyModification().addRoles("reviews-only-role"));
        authIdentityManager.createIdentity("id5", APIKEY_STANDARD, new ApiKeyModification().addRoles("standard"));
        authIdentityManager.createIdentity("id6", APIKEY_STANDARD_UPDATE, new ApiKeyModification().addRoles("update-with-events"));
