...
public class RoleResource1 {
    ...
    public SuccessResponse createRole(@PathParam("group") String group, @PathParam("id") String id, EmoRole role,
                                      final @Authenticated Subject subject) {
    ...
    public SuccessResponse createRoleFromUpdateRequest(@PathParam("group") String group, @PathParam("id") String id,
